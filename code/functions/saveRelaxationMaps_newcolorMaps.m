function saveRelaxationMaps_newcolorMaps(maps, maxValue, figName, finalDir, stringName, config)
    ...
    for j = 1:nSlices
        [imClip, rgb_vec] = relaxationColorMap(stringName, maps(:,:,j), 0, maxValue);
