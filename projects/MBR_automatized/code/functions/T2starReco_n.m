function [M0starMaps, R2starMaps, T2starMaps, coilSensEPI, synthesizedEPIimages, B0maps] = T2starReco_n(kSpace, traj, TEs, initMaps, protPara)
...
recoSize = baseRes*oversamplingFactor*mobaOS; % not sure yet why the factor of 2
