function [initMaps] = createInitMpasForT2star_m3(kSpace, traj, TEs, R2, synthesizedRAREimages, binaryMaskRARE, protPara)
...
for slice = 1:nSlices
    ...
    switch whichInit
        ...
        case 1
            ...
            initR2star = initR2star .* 0.001 .* scalingFactorR2star; % 0.001 so R2 is in Khz, since MOBA here works in ms
            initB0 = zeros(nSamples,nSamples,1);
            initB0_img = zeros(nSamples,nSamples,1);
        case 2
        ...
        case 3
            ...
            initM0 = normalizeArray(lastSynthetic) .* scalingFactorM0;
            initR2star = R2(:,:,slice).*binaryMaskRARE(:,:,slice);
            initR2star = initR2star .* 0.001 .* scalingFactorR2star; % so initR2star is in KiloHertz 
        case 4
...
changeBartVersion(9)% come back to bart v09
end