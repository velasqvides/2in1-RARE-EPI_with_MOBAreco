...
for s=1:NScans
    ...
    % Edited 2019-08-15 for gradient delay calibration, Carl Herrmann
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    twix_obj{s}.gdelcalib_0   = twix_map_obj(arg,'gdelcalib_0',filename,version);
    twix_obj{s}.gdelcalib_180 = twix_map_obj(arg,'gdelcalib_180',filename,version);
    twix_obj{s}.gdelcalib_90  = twix_map_obj(arg,'gdelcalib_90',filename,version);
    twix_obj{s}.gdelcalib_270 = twix_map_obj(arg,'gdelcalib_270',filename,version);
    twix_obj{s}.gdelcalib_30  = twix_map_obj(arg,'gdelcalib_30',filename,version);
    twix_obj{s}.gdelcalib_210 = twix_map_obj(arg,'gdelcalib_210',filename,version);
    twix_obj{s}.gdelcalib_60  = twix_map_obj(arg,'gdelcalib_90',filename,version);
    twix_obj{s}.gdelcalib_240 = twix_map_obj(arg,'gdelcalib_240',filename,version);
    twix_obj{s}.gdelcalib_120 = twix_map_obj(arg,'gdelcalib_120',filename,version);
    twix_obj{s}.gdelcalib_300 = twix_map_obj(arg,'gdelcalib_300',filename,version);
    twix_obj{s}.gdelcalib_150 = twix_map_obj(arg,'gdelcalib_150',filename,version);
    twix_obj{s}.gdelcalib_330 = twix_map_obj(arg,'gdelcalib_330',filename,version);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if arg.bReadPCScan
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % read gradient delay calibration scans
        clear tmpMdh
        isCurrScan = (and(mask.MDH_PHASCOR,~mask.MDH_PATREFSCAN)& mdh.aushIceProgramPara(:,6)==1);
        for f = fieldnames( mdh ).'
            tmpMdh.(f{1}) = mdh.(f{1})( isCurrScan, : );
        end
        twix_obj{s}.gdelcalib_0.readMDH( tmpMdh, filePos(isCurrScan) );
        
        clear tmpMdh
        isCurrScan = (and(mask.MDH_PHASCOR,~mask.MDH_PATREFSCAN)& mdh.aushIceProgramPara(:,6)==2);
        for f = fieldnames( mdh ).'
            tmpMdh.(f{1}) = mdh.(f{1})( isCurrScan, : );
        end
        twix_obj{s}.gdelcalib_180.readMDH( tmpMdh, filePos(isCurrScan) );
        
                clear tmpMdh
        isCurrScan = (and(mask.MDH_PHASCOR,~mask.MDH_PATREFSCAN)& mdh.aushIceProgramPara(:,6)==3);
        for f = fieldnames( mdh ).'
            tmpMdh.(f{1}) = mdh.(f{1})( isCurrScan, : );
        end
        twix_obj{s}.gdelcalib_90.readMDH( tmpMdh, filePos(isCurrScan) );
        
        clear tmpMdh
        isCurrScan = (and(mask.MDH_PHASCOR,~mask.MDH_PATREFSCAN)& mdh.aushIceProgramPara(:,6)==4);
        for f = fieldnames( mdh ).'
            tmpMdh.(f{1}) = mdh.(f{1})( isCurrScan, : );
        end
        twix_obj{s}.gdelcalib_270.readMDH( tmpMdh, filePos(isCurrScan) );
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        clear tmpMdh
        isCurrScan = mask.MDH_PHASCOR & ( ~mask.MDH_PATREFSCAN | mask.MDH_PATREFANDIMASCAN) & mdh.aushIceProgramPara(:,6)==0;
        for f = fieldnames( mdh ).'
            tmpMdh.(f{1}) = mdh.(f{1})( isCurrScan, : );
        end
    ...
    for scan = { 'image', 'noise', 'phasecor', 'phasestab', ...
                 ...
                 'gdelcalib_0','gdelcalib_90','gdelcalib_180',...
                 'gdelcalib_270','gdelcalib_30','gdelcalib_210',...
                 'gdelcalib_240','gdelcalib_120','gdelcalib_300',...
                 'gdelcalib_150','gdelcalib_330','gdelcalib_60'}
        f = scan{1};
