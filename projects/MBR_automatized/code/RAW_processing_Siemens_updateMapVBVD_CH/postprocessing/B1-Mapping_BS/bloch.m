...
%
%   MD
%    (0=end point only, one excitation from M0           
%     1=end point only, steady state
%     2=time lapse, one excitation from M0 
%     3=time lapse, steady state)
%       option 1 and 3 are still a bit unclear to me...
%
%	(optional)
