function [Maps,detailedB1postprocessingData]=B1Mapping_20161012(combinedImage,MrProt,newDataDims,config)
...
if Sequence.Nucleus == '1H'                                                 % TE added to avoid error in sensitivity build
